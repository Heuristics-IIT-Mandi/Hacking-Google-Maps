...
3. Relay the information to the user using OFFLINE CACHING IN MEMORY / CLOUD PROCESSING when he/she wanna search a place /reach a place .  
...
<img src="b18074/correction.gif" width=800 height=800>
...
Other Heuristics can be FUEL SAVINGS , TURNS , INTERSECTIONS ,SPEED , NO OF ROAD LANES , HIGHWAY OR NOT etc . 
...
With Heuristics Accuracy will increase as seen below and maybe time also decrease because now we can straight away cancel a route if it violates heuristic and we need not traverse on that route , just see Djikstra below how many points it is traversing so I believe it is subjective and based on our model . 
 ...
 <img src="b18074/map.jpg" width=800 height=2000> 
